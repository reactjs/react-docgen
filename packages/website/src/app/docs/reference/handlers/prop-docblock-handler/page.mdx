...
- [Implementation](https://github.com/reactjs/react-docgen/blob/main/packages/react-docgen/src/handlers/propDocblockHandler.ts)
- [Tests](https://github.com/reactjs/react-docgen/blob/main/packages/react-docgen/src/handlers/__tests__/propDocblockHandler-test.ts)
