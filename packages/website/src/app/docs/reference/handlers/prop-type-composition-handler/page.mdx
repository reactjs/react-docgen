...
- [Implementation](https://github.com/reactjs/react-docgen/blob/main/packages/react-docgen/src/handlers/propTypeCompositionHandler.ts)
- [Tests](https://github.com/reactjs/react-docgen/blob/main/packages/react-docgen/src/handlers/__tests__/propTypeCompositionHandler-test.ts)
