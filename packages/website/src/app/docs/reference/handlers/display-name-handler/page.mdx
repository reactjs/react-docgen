...
- [Implementation](https://github.com/reactjs/react-docgen/blob/main/packages/react-docgen/src/handlers/displayNameHandler.ts)
- [Tests](https://github.com/reactjs/react-docgen/blob/main/packages/react-docgen/src/handlers/__tests__/displayNameHandler-test.ts)
