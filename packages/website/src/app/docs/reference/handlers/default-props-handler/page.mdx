...
- [Implementation](https://github.com/reactjs/react-docgen/blob/main/packages/react-docgen/src/handlers/defaultPropsHandler.ts)
- [Tests](https://github.com/reactjs/react-docgen/blob/main/packages/react-docgen/src/handlers/__tests__/defaultPropsHandler-test.ts)
