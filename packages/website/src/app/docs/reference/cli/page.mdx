...
<Callout type="warning" emoji="">
  The `--handler`, `--resolver`, and `--importer` options can load JavaScript
  modules from paths or package names. These modules are executed as trusted
  code with the same privileges as the current Node.js process. Do not populate
  these options from untrusted input, user-provided configuration, or unreviewed
...
working directory. The handler module is executed as trusted JavaScript code.

#### Module name of handler

An npm module name can be specified. The default export of this module needs to
be the handler function. Only use modules you trust.
...
or relative and in the later case the path will be resolved from the current
working directory. The importer module is executed as trusted JavaScript code.

#### Module name of importer

An npm module name can be specified. The default export of this module needs to
be the importer. Only use modules you trust.
...
or relative and in the later case the path will be resolved from the current
working directory. The resolver module is executed as trusted JavaScript code.

#### Module name of resolver

An npm module name can be specified. The default export of this module needs to
be an instance of the resolver. Only use modules you trust.
